    ...
    <div class="container d-flex justify-content-center">
        <div class="form-wrapper medium">
            ...
            <form:form action="editProfileProcess" method="POST" modelAttribute="profile">
                ...
                <label class="fs-6 form-label">Prenume</label>
                <div>
