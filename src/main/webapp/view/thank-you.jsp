    ...
    <section class="mt-5">
        <div class="container d-flex justify-content-center">
            <div class="confirmation d-flex flex-column text-center">
                ...
                <h2 class="fw-semibold">Multumim pentru inregistrare</h2>
                <p class="text-secondary">Contul dumneavoastra a fost creat, bucurati-va de el</p>
                <div class="wrapper">
                    <a href="<%= request.getContextPath() %>/" class="text-decoration-none">
                        <button class="btn btn-outline-secondary mt-3 me-3">ACASA</button>
                    </a>
